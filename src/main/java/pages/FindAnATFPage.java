...
public class FindAnATFPage extends BasePage {

    private static final String FIND_AN_ATF_TITLE_ID = "Find an ATF";
    ...
    public void waitUntilPageIsLoaded() {
        waitUntilPageIsLoadedById(FIND_AN_ATF_TITLE_ID);
    }
    ...
    public boolean isTitleDisplayed() {
        return getDriver().findElement(By.id(FIND_AN_ATF_TITLE_ID)).isDisplayed();
    }
