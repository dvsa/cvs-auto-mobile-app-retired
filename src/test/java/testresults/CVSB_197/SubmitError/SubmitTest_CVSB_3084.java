...
public class SubmitTest_CVSB_3084 extends BaseTestClass {
    ...
    @Title("CVSB-197 - AC A5. VSA encounters an error whilst attempting to save test results")
    @Test
    public void testErrorWhileSubmittingTestResults() {
