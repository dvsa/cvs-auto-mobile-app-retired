...
public class RemoveDefectTest {
    ...
    @Title("CVSB-145 / CVSB-661 - AC1- Remove defect pop up message")
    @Test
    ...
    @Title("CVSB-145 / CVSB-662 - AC2 - Confirm remove defect")
    @Test
    public void testConfirmRemoveDefect() {
        ...
        testTypeSteps.swipeDefect("3.1.b MAJOR");
        testTypeSteps.pressRemove();
        testTypeSteps.pressRemoveInPopUp();
        testTypeSteps.checkDefectRemoved("3.1.b MAJOR");
    }

    @Title("CVSB-145 / CVSB-663 - AC3 - Cancel remove defect")
    @Test
