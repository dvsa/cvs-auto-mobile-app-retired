...
public class ProhibitionFieldNotDisplayed_CVSB_4829_9 extends BaseTestClass {
    ...
    @Title("CVSB-3179 - TCD - AC1 - Prohibition field not displayed at a defect level (Prohibition Clearance) - 9")
    @Test
    public void prohibitionFieldNotDisplayedAtADefectLevelProhibitionClearenceFullInspectionFullFeeWithCert_9() {
