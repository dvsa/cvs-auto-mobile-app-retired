...
public class ProhibitionFieldNotDisplayed_CVSB_4829_3 extends BaseTestClass {
    ...
    @Title("CVSB-3179 - TCD - AC1 - Prohibition field not displayed at a defect level (Prohibition Clearance) - 3")
    @Test
    public void prohibitionFieldNotDisplayedAtADefectLevelProhibitionClearenceFullInspectionPartFee_3() {
