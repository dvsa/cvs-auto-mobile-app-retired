...
public class TestTypeLinked_CVSB_4676 extends BaseTestClass {
    ...
    @Test
    @Title("CVSB-444 - TCD - AC1 As a VSA I would like to view only relevant linked tests so that I don't have to go through the full test type taxonomy (Prohibition Clearance Any PSV Full Inspec Part Fee)")
    public void testListFromAddLinkedTestTypeProhibitionClearanceAnyPSVFullInspectionPartFee() {
