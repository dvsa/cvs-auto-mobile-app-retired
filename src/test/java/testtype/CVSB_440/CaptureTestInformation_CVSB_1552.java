...
public class CaptureTestInformation_CVSB_1552 extends BaseTestClass {
    ...
    @Title("CVSB-440 - AC3 - VSA views technical record fields")
    @Test
    public void testVsaViewsTechnicalRecordFields() {
        ...
        testHistorySteps.checkTestTypeRecordInList("string");
